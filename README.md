...
AutoShelf monitors a folder (by default user's downloads) for new files, and instantly creates a shelf to display newly added file. After 30 seconds (the time can be adjusted in the settings), the shelf closes automatically.
